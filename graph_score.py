...
Usage:
    python graph_score.py <image_path> <duration>

Arguments:
    image_path: Path to the image file to analyze
    duration: Total duration of the scanning process in seconds

OSC Output:
    Static Analysis:
    - /image/object_count: Total number of detected objects

    Dynamic Scanning:
    - /image/scan_object_count: Number of objects in current scan area
    - /image/scan_min_size: Minimum object size in scan area
    - /image/scan_avg_size: Average object size in scan area
    - /image/scan_max_size: Maximum object size in scan area
...
def main(image_path, duration):
    ...
    contrast, object_count, _, proximity, _, _, _ = analyze_image(image, display_image.copy())
